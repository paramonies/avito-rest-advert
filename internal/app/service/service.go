...
func (s *Service) CreateAdvert(advert model.Advert) (int, error) {
...
func (s *Service) GetAdvertById(advertId int, fields []string) (model.Advert, error) {
...
func (s *Service) GetAdvertList(page int, orderBy string) ([]model.Advert, error) {
